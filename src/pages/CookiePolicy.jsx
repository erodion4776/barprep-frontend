...
const COOKIE_TYPES = [
  ...
  },
  {
    ...
    desc:  'Remember your preferences such as exam date, study plan, and daily affirmation. Disabling these may limit functionality.',
  },
  {
  ...
  },
  {
    ...
    desc:  'Store your AI chat sessions and blog personalization data locally for continuity between study sessions.',
  },
]
...
const THIRD_PARTIES = [
  {
    name: 'Supabase',
    desc: 'Authentication, database, and file storage provider.',
  ...
  },
  {
    ...
    desc: 'AI text and image generation for blog posts. No personal data sent.',
    url:  'https://pollinations.ai',
  },
  {
    name: 'Groq / AI providers',
    desc: 'Powers the AI Coach chat. Only your typed questions are processed.',
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8 space-y-8">
      ...
      <div className="space-y-10">
        ...
        <Section id="what" title="1. What Are Cookies?">
          <p>
            ...
            a website. BarPrep AI also uses <strong>localStorage</strong> — a
            similar browser storage technology — to save your study preferences
            locally on your device.
          </p>
          <p>
            We do <strong>not</strong> use cookies for advertising or sell your
        ...
        <Section id="specific" title="3. Specific Cookies We Use">
          <p>The table below lists every cookie and localStorage item used by BarPrep AI:</p>
          <div className="overflow-x-auto rounded-xl border border-slate-200">
            <table className="w-full text-xs border-collapse">
              <thead>
                <tr className="bg-slate-100">
                  {['Cookie Name', 'Type', 'Purpose', 'Duration', 'Provider'].map(h => (
                    <th key={h} className="text-left p-3 font-bold text-slate-700
              ...
              <tbody>
                {ALL_COOKIES.map((c, i) => (
                  <tr key={i} className={`${i % 2 === 0 ? 'bg-white' : 'bg-slate-50'}
                    ...
                    <td className="p-3 border-b border-slate-100 font-mono text-slate-700 whitespace-nowrap">
                      {c.name}
                    </td>
                    ...
                    <td className="p-3 border-b border-slate-100 text-slate-600 whitespace-nowrap">
                      {c.duration}
                    </td>
                    <td className="p-3 border-b border-slate-100 text-slate-600 whitespace-nowrap">
                      {c.provider}
        ...
        <Section id="managing" title="5. Managing Your Cookie Preferences">
          ...
          <div className="space-y-3">
            {[
              { title: 'Cookie Banner',    desc: 'Accept or decline non-essential cookies when you first visit.' },
              { title: 'Browser Settings', desc: 'Most browsers allow you to block or delete cookies in their settings.' },
              { title: 'Reset Preferences', desc: 'Use the button below to clear your consent and see the banner again.' },
            ].map(({ title, desc }) => (
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 mt-3">
            <p className="text-xs text-amber-800">
              ⚠️ <span className="font-bold">Note:</span> Disabling essential cookies
              will prevent you from logging in and using the app.
            </p>
          </div>
        </Section>

        <Section id="gdpr" title="6. Your Legal Rights">
          <p>Depending on your location, you may have rights under applicable privacy laws:</p>
        ...
        <Section id="contact" title="7. Contact Us">
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-4 space-y-1">
            <p className="text-sm font-medium text-slate-800">BarPrep AI — Privacy Team</p>
            <a href="mailto:privacy@barprepai.com" className="text-sm text-blue-600 hover:underline">
              privacy@barprepai.com
            </a>
            <p className="text-xs text-slate-400">We respond to privacy requests within 30 days.</p>
          </div>
        </Section>
      ...
      <div className="border-t border-slate-200 pt-6 flex flex-wrap gap-4">
        ...
        <Link to="/settings"   className="text-sm text-blue-600 hover:underline font-medium">Cookie Settings →</Link>
      </div>
