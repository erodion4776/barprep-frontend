...
export const apiClient = {
  ...
  // ── Affirmation ───────────────────────────────────────────────────────────
  // Reads from Supabase DB first (pre-generated by GitHub Actions cron)
  // Falls back to Edge Function if no entry exists for today
  getAffirmation: async () => {
    const today = new Date().toISOString().split('T')[0]

    // Method 1: Read directly from Supabase database (instant)
    try {
    ...
    // Method 2: Call Edge Function (generates on demand)
    try {
